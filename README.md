...
-- A RDBMS is the system that manages storage, querying, updating, etc...
-- SQL is a language that is typically used to query and interact with the RDBMS
...
-- A third table that holds foreign keys that reference the primary key in the related table.
